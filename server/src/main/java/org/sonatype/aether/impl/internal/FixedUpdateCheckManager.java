...
import org.sonatype.aether.transfer.*;
...
/**
 * Copy of the original class {@link DefaultUpdateCheckManager} with a fix to the
 * {@link #checkMetadata(org.sonatype.aether.RepositorySystemSession, org.sonatype.aether.impl.UpdateCheck)} method
 * @author yoav
 * @since 3/5/12
 */
@Component( role = UpdateCheckManager.class )
public class FixedUpdateCheckManager implements UpdateCheckManager, Service
{
    ...
    public FixedUpdateCheckManager()
    {
        // enables default constructor
    }

    public FixedUpdateCheckManager( Logger logger )
    {
        setLogger(logger);
    }
    ...
    public FixedUpdateCheckManager setLogger( Logger logger )
    {
