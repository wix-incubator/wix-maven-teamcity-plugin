...
public class FixedDefaultVersionResolver implements VersionResolver, Service {
    ...
    public FixedDefaultVersionResolver setLogger( Logger logger )
    {
        this.logger = ( logger != null ) ? logger : NullLogger.INSTANCE;
        return this;
    }

    public FixedDefaultVersionResolver setMetadataResolver( MetadataResolver metadataResolver )
    {
    ...
    public FixedDefaultVersionResolver setSyncContextFactory( SyncContextFactory syncContextFactory )
    {
    ...
    public FixedDefaultVersionResolver setRepositoryEventDispatcher( RepositoryEventDispatcher repositoryEventDispatcher )
    {
